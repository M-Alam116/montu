        ...
        <div className='py-[5rem]'>
            <div className="container flex-col md:flex-row gap-[2rem] items-center">
                <div className="flex flex-col gap-[1rem]">
                    ...
                    <p className="text-[16px] font-[500] leading-[24px] text-[--blackColor] w-[60%]">La primera aplicación con la cual podrás colaborar con marcas, agencias y otros creadores.</p>
